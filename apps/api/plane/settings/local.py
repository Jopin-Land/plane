...
CUSTOM_USER_CREATED_WEBHOOK_URLS = os.getenv("CUSTOM_USER_CREATED_WEBHOOK_URLS", "")
CUSTOM_USER_WEBHOOK_SECRET       = os.getenv("CUSTOM_USER_WEBHOOK_SECRET", "")
CUSTOM_USER_WEBHOOK_TIMEOUT      = int(os.getenv("CUSTOM_USER_WEBHOOK_TIMEOUT", "4"))
